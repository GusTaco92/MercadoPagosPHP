...
<p class="as-producttile-tilelink">Dispositivo móvil de Tienda e-commerce</p>
                                            </h3>
                                        </div>
                                        <h3 >
                                        ...
                                        <h3 >
                                            <?php echo "Pedido: ioriferreri1992@hotmail.com " ?>
                                        </h3>
                                    </div>
                            <?php
                                // SDK de Mercado Pago
                                ...
                                $preference->expiration_date_from="2020-11-09T12:00:00.000-04:00";
                                $preference->expiration_date_to=date("Y-m-d",strtotime($preference->expiration_date_from. "+ 6 month"))."T12:00:00.000-04:00";
                                ...
                                $payer->date_created = "2020-11-09T12:58:41.425-04:00";
                                $payer->phone = array(
                                    "area_code" => "52",
                                    "number" => "5549737300"
                                );
